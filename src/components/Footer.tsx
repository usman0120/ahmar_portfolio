  ...
  return (
    <footer className="bg-accent text-white">
      <div className="container-custom section-padding">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <h3 className="text-2xl font-heading font-bold text-white">
              Muhammad Ahmar Saleem
            </h3>
            <p className="text-secondary text-lg">
              Flutter Developer & Software Engineering Student
            </p>
            <p className="text-gray-300">
              Building modern, fast, and beautiful mobile applications with Flutter.
            </p>
          </motion.div>
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="p-2 bg-white bg-opacity-10 rounded-xl hover:bg-primary transition-all duration-300"
                >
                  {social.icon}
                </motion.a>
              ))}
        ...
        >
          <p className="text-gray-300">
            © {currentYear} Muhammad Ahmar Saleem. All rights reserved.
          </p>
          <p className="text-secondary text-sm mt-2">
            Made with ❤️ by Ahmar Saleem
          </p>
        </motion.div>
      </div>
    </footer>
